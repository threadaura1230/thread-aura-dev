      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div className="flex flex-col space-y-3 text-[13px] md:text-[14px] font-light">
            <a href="#" className="hover:opacity-70 transition-opacity w-fit">Privacy Policy</a>
            <a href="#" className="hover:opacity-70 transition-opacity w-fit">Accessibility Statement</a>
            <a href="#" className="hover:opacity-70 transition-opacity w-fit">Shipping Policy</a>
            <a href="#" className="hover:opacity-70 transition-opacity w-fit">Terms & Conditions</a>
            <a href="#" className="hover:opacity-70 transition-opacity w-fit">Refund Policy</a>
          </div>
